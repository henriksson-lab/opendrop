# Tiselius — build, test, and cross-platform packaging.
#
...
help: ## Show this help
	@printf 'Tiselius %s — make targets:\n\n' "$(APP_VERSION)"
...
install: release ## Install binary + .desktop + icons into $(PREFIX)
	...
	install -Dm644 packaging/tiselius.desktop "$(DATADIR)/applications/$(LINUX_APP_ID).desktop"
...
package-windows: ## Build tiselius.exe and zip it (Windows host or cross)
